...
namespace pml {
    ...
    /**
    * @fn inner_product_AVX(const double* inA, const double* inB, std::size_t inSize)
    *
    * @brief
    ...
    */
    ...
    /**
    * @fn inner_product_AVX(const std::vector<double>& inA, const std::vector<double>& inB)
    *
    * @brief
    ...
    */
    ...
    namespace aligned {
        ...
        /**
        * @fn inner_product_AVX(const alvector<double>& inA, const alvector<double>& inB)
        *
        * @brief
