...
namespace pml {
    ...
    */
    namespace CPUDispatcher {
        ...
        */
        inline const std::string& getVendor() { return gCPUData.vendor_; }

        /**
        * @brief
        * Getting brand name of runtime CPU, Intel Core(TM) i7-XXX...
        */
        inline const std::string& getBrand() { return gCPUData.brand_; }

        /**
        * Is SSE supported ?
        */
        inline bool isSSE() { return gCPUData.f_1_EDX_[25]; }

        /**
        * Is SSE2 supported ?
        */
        inline bool isSSE2() { return gCPUData.f_1_EDX_[26]; }

        /**
        * Is SSE3 supported ?
        */
        inline bool isSSE3() { return gCPUData.f_1_ECX_[0]; }

        /**
        * Is SSSE3 supported ?
        */
        inline bool isSSSE3() { return gCPUData.f_1_ECX_[9]; }

        /**
        * Is SSE4.1 supported ?
        */
        inline bool isSSE41() { return gCPUData.f_1_ECX_[19]; }

        /**
        * Is SSE4.2 supported ?
        */
        inline bool isSSE42() { return gCPUData.f_1_ECX_[20]; }

        /**
        * Is FMA supported ?
        */
        inline bool isFMA() { return gCPUData.f_1_ECX_[12]; }

        /**
        * Is AVX supported ?
        */
        inline bool isAVX() { return gCPUData.f_1_ECX_[28]; }

        /**
        * Is AVX2 supported ?
        */
        inline bool isAVX2() { return gCPUData.f_7_EBX_[5]; }

        /**
        * Are standard AVX512 instructions supported ?
        */
        inline bool isAVX512F() { return gCPUData.f_7_EBX_[16]; }

        /**
        * Is AVX512PF supported ?
        */
        inline bool isAVX512PF() { return gCPUData.f_7_EBX_[26]; }

        /**
        * Is AVX512ER supported ?
        */
        inline bool isAVX512ER() { return gCPUData.f_7_EBX_[27]; }

        /**
        * Is AVX512CD supported ?
        */
        inline bool isAVX512CD() { return gCPUData.f_7_EBX_[28]; }
